...
import { tagsSelected } from '../../redux/features/blogs/filter/filterSlice';
...
const CategoryList = () => {
  ...
  return (
    ...
    <ul>
      ...
      ${isTagSelected ("AI") ? " selected bg-indigo-200 rounded" :""}`}>
      ...
      <li className={`px-1 py-4 border-b border-t border-white hover:border-gray-200 transition duration-300
      ${isTagSelected ("Startups") ? " selected bg-indigo-200 rounded" :""}`}>
      ...
      <li className={`px-1 py-4 border-b border-t border-white hover:border-gray-200 transition duration-300
      ${isTagSelected ("Tech") ? " selected bg-indigo-200 rounded" :""}`}>
      ...
      <li className={`px-1 py-4 border-b border-t border-white hover:border-gray-200 transition duration-300
      ${isTagSelected ("Apps") ? " selected bg-indigo-200 rounded" :""}`}>
