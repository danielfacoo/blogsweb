    ...
    return (
        ...
        <div className="p-4 absolute bottom-0 left-0 z-20">
          ...
          <div className="flex mt-3">
            ...
            <div>
              ...
              <p className="font-semibold text-gray-400 text-xs"> 4 Apr </p>
            </div>
          </div>
        </div>
      </a>
      ...
      >
        ...
        <div className="p-4 absolute bottom-0 left-0 z-20">
          ...
          <div className="flex mt-3">
            <img src="https://randomuser.me/api/portraits/men/98.jpg" className="h-10 w-10 rounded-full mr-2 object-cover" alt="Author" />
            <div>
